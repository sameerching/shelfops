...
def test_nan_dispatch_qty_creates_row_level_error() -> None:
    seed_brand(751)
    seed_skus(751, ["SKU-1"])

    response = upload_dispatch(751, "sku_code,platform,city,dispatch_qty,dispatch_status,dispatch_date\nSKU-1,Blinkit,Mumbai,NaN,open,2026-04-01\n")
